  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      bottomNavigationBarTheme: const BottomNavigationBarThemeData(
        ...
        selectedLabelStyle: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, fontFamily: 'Poppins'),
      ...
      chipTheme: ChipThemeData(
        ...
        labelStyle: const TextStyle(color: AppColors.primary, fontSize: 12, fontFamily: 'Poppins'),
      ...
      textTheme: const TextTheme(
        ...
        titleMedium: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: AppColors.textPrimary, fontFamily: 'Poppins'),
        titleSmall: TextStyle(fontSize: 13, fontWeight: FontWeight.w500, color: AppColors.textSecondary, fontFamily: 'Poppins'),
        bodyLarge: TextStyle(fontSize: 15, color: AppColors.textPrimary, fontFamily: 'Poppins'),
        bodyMedium: TextStyle(fontSize: 14, color: AppColors.textPrimary, fontFamily: 'Poppins'),
        bodySmall: TextStyle(fontSize: 12, color: AppColors.textSecondary, fontFamily: 'Poppins'),
        labelLarge: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, fontFamily: 'Poppins'),
        labelSmall: TextStyle(fontSize: 11, color: AppColors.textSecondary, fontFamily: 'Poppins'),
      ),
    );
  }
}
